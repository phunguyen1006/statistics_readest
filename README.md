...
[![Version](https://img.shields.io/badge/version-2.2.0-black)](https://github.com/phunguyen1006/statistics_readest/releases/latest)
...
Readest Stats is an independent native Windows desktop companion for digital and physical reading. Version 2.2.0 unifies Today around a single Next up queue, adds real comparison overlays to reading trends, turns Data Health and backups into action centers, preserves a durable undo journal, expands Random Note Studio, and adds duplicate-aware physical-library maintenance—all without modifying Readest.

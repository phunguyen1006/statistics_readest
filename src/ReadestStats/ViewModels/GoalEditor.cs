...
public sealed class GoalEditor : ObservableObject
{
    ...
    public string MetricLabel => Definition.Metric switch { GoalMetric.Books => "Books with activity", GoalMetric.ActiveDays => "Active days", GoalMetric.Sessions => "Sessions", _ => "Reading time" };
